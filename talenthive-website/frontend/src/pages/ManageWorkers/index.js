...
import styles from '../../styles/pages/ManageWorkers.module.css'
...
function ManageWorkers() {
    ...
    return (  
        <div className={styles.wrapper}>
            ...
            <div className={styles['wokers-container']}>
                <div className={styles['wokers-list']}>
                    {items_filter[state].map((item, index) => {
                        return (
                            <div key={index} index={index} className={`${index===selected && styles.selected} ${styles.worker}`} onClick={handleClick}>
                ...
                <div className={styles['worker-detail']}>
                    <div>
                        <ProfileDashboard props={items_filter[state][selected]} isReused={true} role={'Worker'}/>
                    </div>
                </div>
